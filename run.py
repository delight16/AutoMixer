...
class RunManager(Exp_Basic):
    ...
    def initialize(self, train_steps):
        ...
        if self.args.model == "Autostg":
            ...
            # adj_mats = np.ones((self.args.enc_in, self.args.enc_in, 4))
    ...
    #     #self.load_pth(os.path.join(self.args.checkpoints + setting, 'checkpoint.pth'), train_steps)
    #     self.load_pth(os.path.join(self.args.checkpoints + setting, 'train.pth'), train_steps)
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader): 
                ...
                if self.args.model == "Autostg":
                    ...
                    outputs_a = self.model(x_search_a, self.node_fts, self.adj_mats, Mode.TWO_PATHS)
